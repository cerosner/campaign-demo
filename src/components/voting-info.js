...
const VotingInfo = () => (
  <div id="register">
    ...
    <div className="panel-register">
      ...
      <ul id="list-register">
        <li>
          Election day is <span>Tuesday, November 5th, 2019</span>.
        </li>
        <li>
          The 6th Ward voting center is located at <span>Demarest School, 401 Garden Street</span>.
        </li>
        <li id="sub-li">
        ...
        <li>
          If not, <a href="https://bit.ly/2OiqTx8" target="_blank">click here</a> to register online.
        </li>
        <li>
          Be sure to register by <span>Tuesday, October 15th, 2019</span>.
        </li>
      </ul>
    </div>
  </div>
